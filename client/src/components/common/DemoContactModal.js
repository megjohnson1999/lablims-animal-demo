...
const DemoContactModal = () => {
  ...
  const actionMessages = {
    ...
    'add_animal': 'add animals to your facility',
    'edit_animal': 'edit animal information',
    'delete_animal': 'remove animals',
    'claim_animal': 'claim animals for studies',
    'add_study': 'create research studies',
    'add_measurement': 'record measurements',
    'manage_housing': 'manage housing units',
