...
const DocumentUpload = ({ 
  ...
  const handleFileSelect = useCallback((selectedFile) => {
    ...
    if (!isValidExtension && !isValidMimeType) {
      setError('Invalid file type. Only PDF, Word documents, text files, and markdown files are allowed.');
      return;
    }
          ...
          {!file ? (
            ...
            >
              <input
                id="document-upload"
                type="file"
                accept=".pdf,.docx,.doc,.txt,.md,.markdown,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,text/plain,text/markdown"
