...
const ProtocolForm = () => {
  ...
  const handleCsvReagentsLoaded = (reagents) => {
            ...
            <Stepper orientation="vertical" sx={{ ml: 2 }}>
              <Step active>
                ...
                <StepContent>
                  <Typography variant="body2" color="text.secondary">
                    First, upload your protocol document (Word/PDF) via the Documents library for reference
                  </Typography>
                </StepContent>
              </Step>
              ...
              <Step active>
                <StepLabel 
                  ...
                  sx={{ '& .MuiStepLabel-label': { fontSize: '0.9rem' } }}
                >
                  Use External AI for Reagent Extraction
                </StepLabel>
                <StepContent>
                  <Typography variant="body2" color="text.secondary">
                    Copy the AI prompt from the CSV upload tab and use it with ChatGPT, Claude, or other AI tools
                  </Typography>
                </StepContent>
              </Step>
              ...
              <Step active>
                ...
                <StepContent>
                  <Typography variant="body2" color="text.secondary">
                    Upload the AI-generated CSV and review the validation results
                  </Typography>
                </StepContent>
              </Step>
